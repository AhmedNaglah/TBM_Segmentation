...
class condGAN1024(condGANBase):
    ...
    def Generator(self):
        ...
        down_stack = [
            self.downsample(64, 4, apply_batchnorm=False),  # (batch_size, 512, 512, 64)
            self.downsample(64, 4),  # (batch_size, 256, 256, 64)
            self.downsample(64, 4),  # (batch_size, 128, 128, 64)
        ...
        up_stack = [
            ...
            self.upsample(64, 4),  # (batch_size, 256, 256, 64)
            self.upsample(64, 4),  # (batch_size, 512, 512, 64)
        ]
    ...
    def Discriminator(self):
        ...
        down0_ = self.downsample(64, 4, False)(x)  # (batch_size, 512, 512, 64)
        down0 = self.downsample(64, 4)(down0_)  # (batch_size, 256, 256, 64)
        down1 = self.downsample(64, 4)(down0)  # (batch_size, 128, 128, 64)
